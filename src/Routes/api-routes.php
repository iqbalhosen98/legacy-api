...
// Controllers
use Mrpath\API\Http\Controllers\Shop\AddressController;
use Mrpath\API\Http\Controllers\Shop\CartController;
use Mrpath\API\Http\Controllers\Shop\CategoryController;
use Mrpath\API\Http\Controllers\Shop\CheckoutController;
use Mrpath\API\Http\Controllers\Shop\CoreController;
use Mrpath\API\Http\Controllers\Shop\CustomerController;
use Mrpath\API\Http\Controllers\Shop\ForgotPasswordController;
use Mrpath\API\Http\Controllers\Shop\InvoiceController;
use Mrpath\API\Http\Controllers\Shop\OrderController;
use Mrpath\API\Http\Controllers\Shop\ProductController;
use Mrpath\API\Http\Controllers\Shop\ResourceController;
use Mrpath\API\Http\Controllers\Shop\ReviewController;
use Mrpath\API\Http\Controllers\Shop\SessionController;
use Mrpath\API\Http\Controllers\Shop\TransactionController;
use Mrpath\API\Http\Controllers\Shop\WishlistController;
use Mrpath\API\Http\Controllers\Shop\CompareController;
use Mrpath\API\Http\Controllers\Shop\HomeController;
use Mrpath\API\Http\Controllers\Shop\CmsController;

// Resources
use Mrpath\API\Http\Resources\Catalog\Attribute;
use Mrpath\API\Http\Resources\Catalog\AttributeFamily;
use Mrpath\API\Http\Resources\Catalog\Category;
use Mrpath\API\Http\Resources\Catalog\ProductReview;
use Mrpath\API\Http\Resources\Core\Channel;
use Mrpath\API\Http\Resources\Core\Country;
use Mrpath\API\Http\Resources\Core\Currency;
use Mrpath\API\Http\Resources\Core\Locale;
use Mrpath\API\Http\Resources\Core\Slider;
use Mrpath\API\Http\Resources\Customer\Customer;
use Mrpath\API\Http\Resources\Customer\CustomerAddress;
use Mrpath\API\Http\Resources\Customer\Wishlist;
use Mrpath\API\Http\Resources\Customer\Compare;
use Mrpath\API\Http\Resources\Sales\Invoice;
use Mrpath\API\Http\Resources\Sales\Order;
use Mrpath\API\Http\Resources\Sales\OrderTransaction;
use Mrpath\API\Http\Resources\Sales\Shipment;
use Mrpath\API\Http\Resources\Shop\HomePage;
use Mrpath\API\Http\Resources\Shop\CmsPage;
...
use Mrpath\Velocity\Repositories\VelocityCustomerCompareProductRepository;
