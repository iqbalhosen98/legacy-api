...
class SendNotification
{
    ...
    public function sendGCM($data)
    {
        ...
        switch ($type = $data->type) {
            case 'product' :
                $product = app('Mrpath\Product\Repositories\ProductRepository')->findorfail($data->product_category_id);
            ...
            case 'category':
                $category = app('Mrpath\Category\Repositories\CategoryRepository')->findorfail($data->product_category_id);
