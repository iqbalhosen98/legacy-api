...
namespace Mrpath\API\Http\Resources\Core;

use Illuminate\Http\Resources\Json\JsonResource;
use Mrpath\API\Http\Resources\Core\Locale as LocaleResource;
use Mrpath\API\Http\Resources\Core\Currency as CurrencyResource;
