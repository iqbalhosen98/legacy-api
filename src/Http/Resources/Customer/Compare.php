...
namespace Mrpath\API\Http\Resources\Customer;
...
class Compare extends JsonResource
{
    ...
    {
        $this->productFlatRepository = app('Mrpath\Product\Repositories\ProductFlatRepository');

        $this->customerRepository = app('Mrpath\Customer\Repositories\CustomerRepository');
