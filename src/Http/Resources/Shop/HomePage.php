...
namespace Mrpath\API\Http\Resources\Shop;
...
class HomePage extends JsonResource
{
    ...
    {
        $this->channelRepository = app('Mrpath\Core\Repositories\ChannelRepository');

        $this->sliderRepository = app('Mrpath\Core\Repositories\SliderRepository');

        $this->velocityHelper = app('Mrpath\Velocity\Helpers\Helper');

        $this->categoryRepository = app('Mrpath\Category\Repositories\CategoryRepository');

        $this->productRepository = app('Mrpath\Product\Repositories\ProductRepository');

        $this->cmsRepository = app('Mrpath\CMS\Repositories\CmsRepository');
